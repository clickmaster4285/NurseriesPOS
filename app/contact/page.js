            ...
            >
              ...
              >
                  ...
                  <div>
                     ...
                     <p className="text-gray-500 font-bold mb-1">General: hello@blossompos.com</p>
                  ...
                  <AnimatePresence mode="wait">
                     {formState === 'success' ? (
                        ...
                        <motion.button
                           ...
                           whileTap={{ scale: 0.98 }}
                           className={`w-full py-6 rounded-3xl font-black text-xl flex items-center justify-center gap-3 shadow-2xl transition-all ${
